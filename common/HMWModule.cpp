...
// Anpassung und Erweiterung durch F. Katzenberger 2017
...
void HMWModule::processEvent(byte const * const frameData, byte frameDataLength, boolean isBroadcast) {
      ...
      // ACKs kommen hier nicht an, werden eine Schicht tiefer abgefangen (HMWRS485)
      ...
      switch(frameData[0]){
         ...
         case 'u':                                                              // Update (Bootloader starten)
        	...
        	// TODO: Bootloader?
			// mögliche lösung ist 2.bootloader (1.=Arduino USB Loader; 2.=HBW loader)
        	break;
	  ...
	  //TODO: ENUM für sendAck (0=keinAck / Frame? 1=Ack 2=info Frame)
      if(sendAck == 2){
         // prepare info Frame
